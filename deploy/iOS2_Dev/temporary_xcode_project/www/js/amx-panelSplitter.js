...
(function($)
{
  ...
  panelSplitter.prototype.createChildrenNodes = function(amxNode)
  {
    ...
    amxNode.setVolatileState({ "resolvedSelectedItemId": resolvedSelectedItemId });
  ...
  panelSplitter.prototype.updateChildren = function(amxNode, attributeChanges)
  {
    ...
    if (attributeChanges.hasChanged("selectedItem"))
    {
      ...
      if (newSelectedItem != oldSelectedItem)
      {
        ...
        amxNode.setVolatileState(
          { "resolvedSelectedItemId": selectedTag.getAttribute("id") });
  ...
  panelSplitter.prototype.render = function(amxNode)
  {
    ...
    try
    {
      ...
      if (navigatorChildren.length > 0)
      {
        ...
        if (inLandscape)
        {
          adf.mf.internal.amx.addCSSClassName(content, "amx-landscape");
        ...
        {
          adf.mf.internal.amx.addCSSClassName(content, "amx-portrait");
        }
      }
      else
      {
        adf.mf.internal.amx.addCSSClassName(content, "amx-noNavigation");
      }
      ...
      if (selectedNode != null)
      {
        ...
        if (viewElement != null)
        {
          adf.mf.internal.amx.addCSSClassName(viewElement, "current");
  ...
  panelSplitter.prototype.refresh = function(amxNode, attributeChanges)
  {
    try
    {
      ...
      if (viewElement != null)
      {
        ...
        amxNode.setVolatileState({ "resolvedSelectedItemId": resolvedSelectedItemId });
        adf.mf.internal.amx.addCSSClassName(viewElement, "new");
        items.appendChild(viewElement);
  ...
  panelSplitter.prototype._handleResize = function(event)
  {
    ...
    if (inner == null)
    {
      ...
      adf.mf.api.amx.removeBubbleEventListener(window, "resize", peer._handleResize, event.data);
      return;
    }
    var foundChildNodes =
        ...
        rootElement.getAttribute("data-orientation") == "portrait" && orientation == "landscape")
    {
      ...
      adf.mf.internal.amx.removeCSSClassName(content, "amx-portrait");
      adf.mf.internal.amx.addCSSClassName(content, "amx-landscape");
    ...
    else if (rootElement.getAttribute("data-orientation") == "landscape" && orientation == "portrait")
    {
      ...
      adf.mf.internal.amx.removeCSSClassName(content, "amx-landscape");
      adf.mf.internal.amx.addCSSClassName(content, "amx-portrait");
