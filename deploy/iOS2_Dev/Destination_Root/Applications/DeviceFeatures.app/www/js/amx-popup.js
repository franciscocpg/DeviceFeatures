...
(function()
{
  function handleResize(event)
  {
    ...
    if (popupElement != null)
    {
      ...
      alignPopup(viewElement, popupElement, alignElementId, align);
    }
  }
  ...
  function alignPopup(viewElement, popupElement, alignElementId, alignValue)
  {
    ...
    for (var i=0; i<alignCandidateCount; ++i)
    {
      ...
      success = attemptAlignPopup(viewElement, popupElement, alignElementId, alignValueToTry);
      if (success)
        break;
    }
  ...
  function attemptAlignPopup(viewElement, popupElement, alignElementId, alignValue)
  {
    ...
    if (popupAnchor != null)
    {
      ...
      adf.mf.internal.amx.removeCSSClassName(popupAnchor, lastAnchorClassName);
      ...
      adf.mf.internal.amx.addCSSClassName(popupAnchor, anchorClassName);
    }
    ...
    var availableTop =
      adf.mf.internal.amx.getElementTop(alignElement) - alignMarginT;
    ...
    else
    {
      switch (alignValue)
      {
        ...
        case ALIGN.ET:
          ...
          popupTop = anchorShiftT + idealTop;
          anchorTop = idealTop;
          break;
        case ALIGN.SM:
        case ALIGN.OMS:
        ...
        case ALIGN.OMC:
          ...
          popupTop = adjustedTop;
          anchorTop = adjustedTop - anchorShiftT;
          if (anchorTop < availableTop)
            hideAnchor = true;
          break;
    ...
    if (horizontallyFits && verticallyFits)
    {
      ...
      if (popupLeft != null)
      {
        ...
        if (anchorStyle != null)
          anchorStyle.left = anchorLeft + "px";
      }
      if (popupRight != null)
      {
        popupStyle.right = popupRight + "px";
        if (anchorStyle != null)
          anchorStyle.right = anchorRight + "px";
      }
      if (popupTop != null)
      {
        popupStyle.top = popupTop + "px";
        if (anchorStyle != null)
          anchorStyle.top = anchorTop + "px";
      }
      if (popupBottom != null)
      {
        popupStyle.bottom = popupBottom + "px";
        if (anchorStyle != null)
          anchorStyle.bottom = anchorBottom + "px";
      }
      return true;
    }
    return false;
...
// TODO finish the migration from "amx.*" to "adf.mf.api.amx.*" and "adf.mf.internal.amx.*"
  ...
  popup.prototype.updateChildren = function(amxNode, attributeChanges)
  {
  ...
  popup.prototype.refresh = function(amxNode, attributeChanges)
  {
  ...
  popup.prototype._showPopup = function(amxNode, completelyNewPopup)
  {
    ...
    if (completelyNewPopup)
    {
      ...
      if (hasTransition)
      {
        setTimeout(function()
        {
          adf.mf.internal.amx.addCSSClassName(popupContainer, "transitioning");
          popupContainerStyle.webkitTransform = "translate(0px,0px)";
