...
(function()
{
    ...
    parentNodeOrTagInstance)
  {
      ...
      ++ati)
    {
      ...
      var valueProvided = attributeValue !== null;
      ...
      // Try to use a default value, if provided.
      if (valueProvided == false && attributeMetaData.defaultValue !== undefined)
      {
  ...
  AttributeMetaData.prototype.Init = function(attributeTag)
  {
    ...
    this.required = getTagTextValue(attributeTag, "required");
